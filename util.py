...
# MIT license
# adapted to return two keys for two paths
...
LEDGER_ETH_DERIVATION_PATH2 = "m/44'/60'/0'/0"
...
def get_private_key(wordstring):
    mnemonic = wordstring.rstrip().lstrip()
    private_key = mnemonic_to_private_key(mnemonic)
    private_key2 = mnemonic_to_private_key(mnemonic, LEDGER_ETH_DERIVATION_PATH2)
    return [str(binascii.hexlify(private_key), 'utf-8'), str(binascii.hexlify(private_key2), 'utf-8')]